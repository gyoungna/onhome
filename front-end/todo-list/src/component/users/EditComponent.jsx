  ...
  <legend style={{borderTop:"3px solid #56cc9d",paddingTop:"25px", borderBottom:"1px solid gray"}}>회원정보 수정 </legend>
    <form>
        ...
        <div>
            ...
            <input style={iStyle} type="email" class="form-control" name="email" value={this.state.user.email} aria-describedby="emailHelp" onChange={(e) => this.setState({user:{...this.state.user,email: e.target.value}})}/>
        </div>
        <div>
