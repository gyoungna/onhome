...
export default class SubmitScore extends Component{
    ...
    state = {
        ...
        count:this.props.location.state.omr.cocount.split(';'),
        co:this.props.location.state.omr.correct.split(';'),
...
submit=(e,arr)=>{
        ...
        var correct=this.state.omr.correct.split(';');//correct 배열
...
render(){
    ...
    let arr = Array.from({length: this.state.omr.cocount.split(';').length}, () => null); 
